...
const Header = () => {
    ...
    const toggleMobileMenu = () => {
        ...
        const mobileMenu = document.getElementById('mondileMenu')
  ...
  return (
    <header className="flex justify-between items-center py-4 px-4 lg:px-20">
        ...
        <h1 data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" className="text-3x1 md:text-4x1 lg:text-5x1 font-light m-0 ">
            MCODE
        </h1>
        ...
        <button className="hidden md:block bg-[#a7a7a7] text-black py-3 px-8 rounded-full border-none font-medium transition-all duration-500 hover:bg-white cursor-pointer z-50">
         ...
         <div id='mondileMenu' className='hidden fiex absolute top-16 bottom-0 right-0 left-0 p-5 md:hidden z-40 bg-black bg-orange-70 backdrop-blur-md '>
